function BatchSummary = RunBatch_Hand(batchInput)
    % Run a batch of Hand-model scenarios from a table or table-containing file.
    ...
    save('BatchSummary_Hand.mat', 'BatchSummary');
end

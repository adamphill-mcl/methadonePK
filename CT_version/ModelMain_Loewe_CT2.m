function [outputArg1,outputArg2] = ModelMain_Loewe_CT2(formulation,CypScore,RF,BW)
    %% Combined script for racaemic methadone. We can run R and S individually, 
    % but need to combine both to form racemic methadone before calculating the combined risk score
    ...
    switch formulation
        case 'R'
            mkdir(strcat('./',formulation, '_CYP_', strrep(num2str(CypScore),'.','_'),'_RF_', strrep(num2str(RF),'.','_'), '_BW_', strrep(num2str(BW),'.','_')))
            flag = 'R';     % Aruldhas flag must be 'R' or 'S' methadone
            dt = 0.1;       % Simulation time step (hours)
            RunTable = RunModel_AH(DoseTable,flag,dt,CypScore,RF,BW);
            ...
            Loewe_metab_IKr = (RunTable.Conc_metab/DrugPars.IC50s('IKr_metab')) .^ DrugPars.h('IKr_metab');
            ...
            Loewe_metab_ICaL = (RunTable.Conc_metab/DrugPars.IC50s('ICaL_metab')) .^ DrugPars.h('ICaL_metab');
            ...
            Loewe_metab_INaL = (RunTable.Conc_metab/DrugPars.IC50s('INaL_metab')) .^ DrugPars.h('INaL_metab');
            ...
            BCaL =  0.691;    % Coefficient of the axis of arrhythmia in LogGCaLScale
            BKr  = -0.617;    % Coefficient of the axis of arrhythmia in LogGKrScale
...
%             save the figures and data
            save(strcat('./',formulation, '_CYP_', strrep(num2str(CypScore),'.','_'), '_RF_', strrep(num2str(RF),'.','_'), '_BW_', strrep(num2str(BW),'.','_'),'/',formulation, '_CYP_', strrep(num2str(CypScore),'.','_'),'_RF_', strrep(num2str(RF),'.','_'),'_BW_', strrep(num2str(BW),'.','_')),'RunTable','DoseTable'); %change this every time
            savefig(figure(1),strcat('./',formulation, '_CYP_', strrep(num2str(CypScore),'.','_'),'_RF_', strrep(num2str(RF),'.','_'),'_BW_', strrep(num2str(BW),'.','_'),'/',formulation, '_CYP_', strrep(num2str(CypScore),'.','_'),'_RF_', strrep(num2str(RF),'.','_'),'_BW_', strrep(num2str(BW),'.','_'),'_', 'stacked','.fig'));
            savefig(figure(2),strcat('./',formulation, '_CYP_', strrep(num2str(CypScore),'.','_'),'_RF_', strrep(num2str(RF),'.','_'),'_BW_', strrep(num2str(BW),'.','_'),'/',formulation, '_CYP_', strrep(num2str(CypScore),'.','_'),'_RF_', strrep(num2str(RF),'.','_'),'_BW_', strrep(num2str(BW),'.','_'),'_', 'overlaid','.fig'));
...
%             save the figures and data
        ...
        case 'racemic'
            ...
            flag = 'R';     % Aruldhas flag must be 'R' or 'S' methadone
            dt = 0.1;       % Simulation time step (hours)
            RunTableR = RunModel_AH(DoseTableRAC,flag,dt,CypScore,RF,BW);
           ...
           %Store overall results in new table
            ...
            flag = 'S';     % Aruldhas flag must be 'R' or 'S' methadone
            %dt = 0.1;       % Simulation time step (hours)
            RunTableS = RunModel_AH(DoseTableRAC,flag,dt,CypScore,RF,BW);
            ...
            Loewe_metabR_IKr = (RunTableR.Conc_metab/DrugPars.IC50s('IKr_metab')) .^ DrugPars.h('IKr_metab');
            Loewe_methS_IKr = (RunTableS.Conc_meth/DrugPars.IC50s('IKr_methS')) .^ DrugPars.h('IKr_methS');
            Loewe_metabS_IKr = (RunTableS.Conc_metab/DrugPars.IC50s('IKr_metab')) .^ DrugPars.h('IKr_metab');
            ...
            Loewe_metabR_ICaL = (RunTableR.Conc_metab/DrugPars.IC50s('ICaL_metab')) .^ DrugPars.h('ICaL_metab');
            Loewe_methS_ICaL = (RunTableS.Conc_meth/DrugPars.IC50s('ICaL_methS')) .^ DrugPars.h('ICaL_methS');
            Loewe_metabS_ICaL = (RunTableS.Conc_metab/DrugPars.IC50s('ICaL_metab')) .^ DrugPars.h('ICaL_metab');
            ...
            Loewe_metabR_INaL = (RunTableR.Conc_metab/DrugPars.IC50s('INaL_metab')) .^ DrugPars.h('INaL_metab');
            Loewe_methS_INaL = (RunTableS.Conc_meth/DrugPars.IC50s('INaL_methS')) .^ DrugPars.h('INaL_methS');
            Loewe_metabS_INaL = (RunTableS.Conc_metab/DrugPars.IC50s('INaL_metab')) .^ DrugPars.h('INaL_metab');
            ...
            % save the figures and data
            save(strcat('./',formulation, '_CYP_', strrep(num2str(CypScore),'.','_'), '_RF_', strrep(num2str(RF),'.','_'), '_BW_', strrep(num2str(BW),'.','_'),'/',formulation, '_CYP_', strrep(num2str(CypScore),'.','_'), '_RF_', strrep(num2str(RF),'.','_'), '_BW_', strrep(num2str(BW),'.','_')),'RunTableR', 'RunTableS', 'MyTable', 'DoseTable'); %change this every time
            savefig(figure(1),strcat('./',formulation, '_CYP_', strrep(num2str(CypScore),'.','_'), '_RF_', strrep(num2str(RF),'.','_'), '_BW_', strrep(num2str(BW),'.','_'),'/',formulation, '_CYP', strrep(num2str(CypScore),'.','_'), '_RF_', strrep(num2str(RF),'.','_'), '_BW_', strrep(num2str(BW),'.','_'), '_', 'stacked','.fig'));
            savefig(figure(2),strcat('./',formulation, '_CYP_', strrep(num2str(CypScore),'.','_'), '_RF_', strrep(num2str(RF),'.','_'), '_BW_', strrep(num2str(BW),'.','_'), '/',formulation, '_CYP', strrep(num2str(CypScore),'.','_'), '_RF_', strrep(num2str(RF),'.','_'), '_BW_', strrep(num2str(BW),'.','_'),'_', 'overlaid','.fig'));
    end  % switch

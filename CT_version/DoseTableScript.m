...
dose_original = 120;                         % Avg dose of 0.087 mg/kg multiplid by average weight of 53.6kg = 4.6632mg
F1_bioavailability = 0.718;                 % Percentage of dose to pass FPM, 0.718 for R-methadone, 0.606 for S-methadone
...
DoseArray = [
    ...
    struct( 'Conc',dose,  'dur',  24,  'MethadoneFlag',flag)
    struct( 'Conc',dose,  'dur',  24,  'MethadoneFlag',flag)
    struct( 'Conc',dose *1,  'dur', 24,  'MethadoneFlag',flag)  % Final dose, followed by 24 hour interval.
    ];

...
%             save the figures and data
        ...
        case 'racemic'
            ...
            %Ask AH if this equation is valid and checks out. e.g. Should R
            %always get first past/first pick?
            ...
            IKrBlock_R = IKrBlock_partEnanR + (IKrBlock_partEnanR .* IKrBlock_partMetabR); % this should be IKrBlock_partEnanR + (1-IKrBlock_partEnanR) .* IKrBlock_partMetabR
            IKrBlock_S = IKrBlock_partEnanS + (IKrBlock_partEnanS .* IKrBlock_partMetabS); %
            IKrBlock_Total = IKrBlock_R + (IKrBlock_R .* IKrBlock_S);
            ...
            ICaLBlock_R = ICaLBlock_partEnanR + (ICaLBlock_partEnanR .* ICaLBlock_partMetabR);
            ICaLBlock_S = ICaLBlock_partEnanS + (ICaLBlock_partEnanS .* ICaLBlock_partMetabS);
            ICaLBlock_Total = ICaLBlock_R + (ICaLBlock_R .* ICaLBlock_S);
            ...
            INaLBlock_R = INaLBlock_partEnanR + (INaLBlock_partEnanR .* INaLBlock_partMetabR);
            INaLBlock_S = INaLBlock_partEnanS + (INaLBlock_partEnanS .* INaLBlock_partMetabS);
            INaLBlock_Total = INaLBlock_R + (INaLBlock_R .* INaLBlock_S);
            ...
            BKr  = -0.58204;    % Coefficient of the axis of arrhythmia in LogGKrScale
            BNaL = 0.377;       % Coefficient of the axis of arrhythmia in LogGNaLScale
            %This is where we are up to, and now facing an error. We had
            %generated separate RunTables for R and S, though in making the
            %total Block values, we abandonned the RunTable entirely
